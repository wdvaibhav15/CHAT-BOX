  ...
  return (
    <div key={user._id} className="p-4 pt-6 flex flex-col justify-between w-72 shadow border border-gray-200 rounded-md">
      <div className="text-center">
        <img src={user.profile_picture} alt="" className="w-16 mx-auto shadow-md rounded-full" />
      ...
      <div className="flex items-center jutify-center gap-2 mt-4 text-sm text-gray-600">
