  ...
  return (
    <div className="w-screen sm:w-[calc(100vw-240px)] lg:max-w-2xl overflow-x-auto no-scrollbar px-4">
      ...
      <div className="flex gap-4 pb-5">
        {/* Create Story Card */}
        <div className="min-w-30 max-w-30 h-40 rounded-lg border-2 border-dashed border-indigo-300 bg-gradient-to-b from-indigo-50 to-white shadow-sm hover:shadow-lg transition-all duration-200 cursor-pointer">
