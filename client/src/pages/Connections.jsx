    ...
    <div className="mb-8 ml-70">
      <div className="max-w-6xl mx-auto p-6">
          ...
          <div className="inline-flex flex-wrap items-center border border-gray-200 rounded-md p-1 bg-white shadow-sm">
            {
              dataArray.map((tab)=>(
                <button onClick={()=>setCurrentTab(tab.label)} key={tab.label} className={`flex items-center px-3 py-1 text-sm rounded-md transition-colors font-bold cursor-pointer ${currentTab === tab.label ? "bg-white font-medium text-indigo-500" : "text-gray-500 hover:text"}`}>
                  ...
                  <div className="flex max-sm:flex-col gap-2 mt-4">
                    {
                      ...
                      className="w-full p-2 text-sm rounded bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition text-white cursor-pointer">View Profile</button>
                    }
                    {
