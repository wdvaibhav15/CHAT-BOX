                  ...
                  <>
                  {
                    post.image_urls.map((image, index)=>(
                      <Link target="_black" to={image} key={index} className="relative group">
                        ...
                        <p className="absolute bottom-0 right-0 text-xs p-1 px-3 backdrop-blur-xl text-white opacity-0 group-hover:opacity-100 transition duravtion-300">Posted {moment(post.createdAt).fromNow()}</p>
                      </Link>
                    ))
                  }
                  </>
